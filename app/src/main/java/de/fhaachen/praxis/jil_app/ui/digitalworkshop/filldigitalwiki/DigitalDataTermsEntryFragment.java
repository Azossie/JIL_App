...
public class DigitalDataTermsEntryFragment extends Fragment {

    private FragmentDigitalDataTermsEntryBinding binding;

    private CategoryDao mCategoryDao;
    private TermsTableDao mTermsTableDao;


    public static DigitalDataTermsEntryFragment newInstance() {
        return new DigitalDataTermsEntryFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentDigitalDataTermsEntryBinding.inflate(inflater, container, false);
        ...
        this.mCategoryDao.firebaseGetCategoryTermsAndShow("digitale-daten");
