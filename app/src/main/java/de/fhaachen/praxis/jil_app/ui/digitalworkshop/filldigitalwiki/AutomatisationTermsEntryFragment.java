...
public class AutomatisationTermsEntryFragment extends Fragment {

    private FragmentAutomatisationTermsEntryBinding binding;

    private CategoryDao mCategoryDao;
    private TermsTableDao mTermsTableDao;


    public static AutomatisationTermsEntryFragment newInstance() {
        return new AutomatisationTermsEntryFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentAutomatisationTermsEntryBinding.inflate(inflater, container, false);
        ...
        this.mCategoryDao.firebaseGetCategoryTermsAndShow("automatisierung");
       ...
       /* if( getArguments() != null ){
        ...
        binding.buttonAddCategoryTerm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openCategoryTermInputDialog(binding.categoryTermsTable, getContext(), mCategoryDao, "automatisierung");
            }
        });
