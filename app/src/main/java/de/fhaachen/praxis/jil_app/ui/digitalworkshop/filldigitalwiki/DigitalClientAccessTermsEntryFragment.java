...
public class DigitalClientAccessTermsEntryFragment extends Fragment {

    private FragmentDigitalClientAccessTermsEntryBinding binding;

    private CategoryDao mCategoryDao;
    private TermsTableDao mTermsTableDao;


    public static DigitalClientAccessTermsEntryFragment newInstance() {
        return new DigitalClientAccessTermsEntryFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentDigitalClientAccessTermsEntryBinding.inflate(inflater, container, false);
        ...
        this.mCategoryDao.firebaseGetCategoryTermsAndShow("digitaler-kundenzugang");
       ...
       /* if( getArguments() != null ){
        ...
        binding.buttonAddCategoryTerm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openCategoryTermInputDialog(binding.categoryTermsTable, getContext(), mCategoryDao, "digitaler-kundenzugang");
            }
        });
