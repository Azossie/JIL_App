...
public class PersonaHowToFragment extends Fragment {

    private FragmentPersonaHowToBinding binding;


    public static PersonaHowToFragment newInstance() {
        return new PersonaHowToFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentPersonaHowToBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        //zurück ans weiter
        binding.backToPersonaDefinition.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Navigation.findNavController(v).navigate(R.id.persona_definition, bundle);
            }
        });

        binding.gotoPersonaQuestions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.persona_questions);
            }
        });
